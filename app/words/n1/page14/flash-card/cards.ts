...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- ちゅうこういっかん",
      "- trường kết hợp trung học cơ sở và trung học phổ thông",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- るいすい",
      "- suy đoán chủ quan từ kinh nghiệm bản thân",
    ],
    more: [
      "📚 Từ loại: Động từ",
