...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- はなばなしい・はかばかしい・はなはだしい",
      "- rực rỡ; trôi chảy; quá mức",
    ],
    more: [
      "📚 Từ loại: Tính từ -i",
  ...
  },
  {
    ...
    back: [
      "- あさましい・いさましい・いたましい・いまわしい",
      "- hèn hạ; dũng mãnh; đáng thương; điềm xấu",
    ],
    more: [
      "📚 Từ loại: Tính từ -i",
  ...
  },
  {
    ...
    back: [
      "- ほつれる・ほどける・ほぐれる・ほころびる",
      "- tuột; cởi ra; thả lỏng; rách bục",
    ],
    more: [
      "📚 Từ loại: Động từ",
