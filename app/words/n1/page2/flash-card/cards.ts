...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- ひとになつく",
      "- thân thiện; gần gũi với người khác",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ひとにはんかんをもつ",
      "- có ác cảm; phản cảm với người khác",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ひとにきがねする",
      "- khách khí; ngại ngùng; e dè với người khác",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ひとをしたう",
      "- yêu mến; kính mến; nhớ nhung người khác",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- にくしん",
      "- máu mủ; ruột rà; người cùng huyết thống",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- ひとにしゅうちゃくする",
      "- lưu luyến; bám víu; chấp vào ai đó",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- いせいにもてる",
      "- được người khác giới yêu thích; thu hút người khác giới",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- きもちをきりかえる",
      "- làm tươi mới tâm trạng; chuyển đổi cảm xúc",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
