...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- いっきょ・いっしん・いちやく",
      "- một lần lớn; hết lòng; nhanh chóng nổi tiếng",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- いっとおり・ちくいち・しんに・じかに・せつに",
      "- lướt qua; từng cái; bằng chứng hiện tại; thật sự; trực tiếp; hết lòng",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- てんてん・もくもく・ゆうゆう",
      "- thay đổi liên tục; lặng lặng làm; thong dong / dư dả",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- つとめて・きょくりょく",
      "- cố gắng trong giới hạn; hết khả năng; chỉ tập trung; chỉ toàn là",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- くまなく・のきなみ・ねこそぎ",
      "- mọi ngóc ngách; tất cả; đồng loạt; không để lại gì",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- おのずと・がんらい・そもそも",
      "- tự nhiên; tự nhiên xảy ra; vốn dĩ từ trước; ngay từ đầu",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- たかが・たかだか",
      "- chỉ là (không to tát); dù nhiều thì cũng chỉ",
    ],
    more: [
      "📚 Từ loại: Phó từ",
