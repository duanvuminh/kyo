...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- やんわり",
      "- chú ý một cách nhẹ nhàng, bóng gió",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- ことごとく",
      "- hoàn toàn, tất cả không sót cái nào",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- あえて",
      "- mạnh dạn làm dù biết khó; cưỡng ép",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- かじょう・かた",
      "- nhiều hơn mức cần thiết; quá nhiều; mật độ quá cao",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    ...
    back: [
      "- かんい・かんべん・かんりゃく・かんけつ",
      "- đơn giản (các sắc thái khác nhau)",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    front: "明朗・明快・明白・明瞭",
    back: [
      "- めいろう・めいかい・めいはく・めいりょう",
      "- rõ ràng (các sắc thái khác nhau)",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    ...
    back: [
      "- そうだい・せいだい・ぼうだい・かだい・ぜつだい",
      "- các mức độ lớn lao khác nhau",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
