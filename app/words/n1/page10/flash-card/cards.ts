...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- きまじめ",
      "- quá nghiêm túc, cứng nhắc (có hơi hướng không tốt)",
    ],
    more: [
      "📚 Từ loại: Tính từ な",
  ...
  },
  {
    ...
    back: [
      "- あいそ",
      "- tính tình chan hòa, gần gũi ↔ khó gần",
    ],
    more: [
      "📚 Từ loại: Cụm tính từ",
  ...
  },
  {
    ...
    back: [
      "- おもんじる↔かろんじる",
      "- coi trọng ↔ khinh thường cá tính",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- きょうかん・どうじょう",
      "- đồng cảm trước khó khăn, đau khổ của người khác",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- はんかん",
      "- phản cảm, ác cảm với người khác",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
