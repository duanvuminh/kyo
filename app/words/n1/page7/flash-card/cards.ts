...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- こうふう",
      "- truyền thống; phong cách của nhà trường",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- どうそうかいにしゅっせきする",
      "- tham dự họp lớp; hội cựu học sinh",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
