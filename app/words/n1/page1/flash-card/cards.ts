...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- きまじめ",
      "- quá nghiêm túc; cực kì nghiêm túc (có hơi hướng không tốt)",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    ...
    back: [
      "- ドライな",
      "- rõ ràng; lạnh nhạt; không để tình cảm xen vào",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- あいそがいい",
      "- tính tình chan hòa; gần gũi; dễ mến",
    ],
    more: [
      "📚 Từ loại: Cụm tính từ",
  ...
  },
  {
    ...
    back: [
      "- ぶあいそう",
      "- lạnh lùng; khó gần gũi; không thân thiện",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    ...
    back: [
      "- ひしゃこうてき",
      "- không có tính xã giao; ít giao tiếp",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    ...
    back: [
      "- ぶえんりょ",
      "- thẳng thắn; không giữ kẽ; thiếu tế nhị",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    ...
    back: [
      "- きょうれつ",
      "- quyết liệt; mạnh mẽ; ấn tượng mạnh",
    ],
    more: [
      "📚 Từ loại: Tính từ -na",
  ...
  },
  {
    ...
    back: [
      "- こせいをはぐくむ",
      "- nuôi dưỡng cá tính của bản thân",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
