...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- あて",
      "- mục tiêu; kì vọng; điều kiện cần",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- ふし",
      "- đốt; khớp xương; giai điệu; điểm cần chú ý",
    ],
    more: [
      "📚 Từ loại: Danh từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- がら",
      "- hoa văn; tính cách; bầu không khí",
    ],
    more: [
      "📚 Từ loại: Danh từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- じく",
      "- trục xoay; thân vật; trung tâm hoạt động",
    ],
    more: [
      "📚 Từ loại: Danh từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- しん",
      "- lõi cứng; sâu thẳm; ý chí mạnh mẽ",
    ],
    more: [
      "📚 Từ loại: Danh từ (nhiều nghĩa)",
