...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- 叶う・適う・敵う",
      "- thực hiện được; thỏa mãn; đối kháng; chịu đựng",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- くだく",
      "- phá vỡ; làm tan biến; giải thích dễ hiểu",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- くれる",
      "- trời tối; rơi vào buồn đau; không biết làm gì",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- こたえる",
      "- chịu đựng; không chịu nổi (nghĩa bóng)",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- しょせん",
      "- rốt cuộc, đánh giá bi quan cuối cùng",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- まんまと",
      "- trót lọt, một cách dễ dàng (thường mang hàm ý bị lừa)",
    ],
    more: [
      "📚 Từ loại: Phó từ",
