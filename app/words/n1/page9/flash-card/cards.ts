...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- ちょうさのてじゅんをかじょうがきにする",
      "- viết ra từng mục một trình tự điều tra",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- きじがこうひょうをはくす",
      "- bài báo được đánh giá tốt; được khen ngợi",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- きじがふひょうをかう",
      "- bài báo bị đánh giá xấu; bị chỉ trích",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- にんきがしたびになる",
      "- sức hút giảm; không còn nổi tiếng",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- オーバーなせんでん",
      "- quảng cáo thổi phồng; quá mức thực tế",
    ],
    more: [
      "📚 Từ loại: Cụm danh từ",
  ...
  },
  {
    ...
    back: [
      "- はんばいぶすう",
      "- số lượng phát hành; số bản bán ra",
    ],
    more: [
      "📚 Từ loại: Danh từ",
