...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- びょうきのちょうこうにきづく",
      "- phát hiện; nhận ra dấu hiệu bệnh",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- からだのふちょうをうったえる",
      "- than thở về sự bất ổn của cơ thể",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- じかくしょうじょう",
      "- triệu chứng do chính người bệnh cảm nhận",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- めんかいしゃぜつになる",
      "- từ chối người đến thăm (bệnh nhân nặng)",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- あんせいをたもつ",
      "- giữ yên tĩnh; nghỉ ngơi tĩnh dưỡng",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
