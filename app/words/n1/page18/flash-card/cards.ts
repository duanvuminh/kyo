...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- しょうしこうれいか",
      "- dân số già thiếu trẻ em tăng nhanh",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- りょうりつ",
      "- làm song song công việc và nuôi dạy con cái",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ふくりこうせい",
      "- chăm lo đầy đủ an sinh phúc lợi",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
