...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- しのぐ",
      "- vượt qua khó khăn; vượt trội hơn",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- たつ",
      "- không tiếp tục; bị gián đoạn; hy vọng tan biến",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- 弾く",
      "- gảy; không thấm nước; từ chối/loại bỏ",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
  ...
  },
  {
    ...
    back: [
      "- はずむ",
      "- nảy; thở dốc; vui vẻ; cuộc trò chuyện sôi nổi; hào phóng",
    ],
    more: [
      "📚 Từ loại: Động từ (nhiều nghĩa)",
