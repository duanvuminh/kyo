...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- いわば・いわゆる・いわく",
      "- có thể ví như; thường gọi là; theo lời nói của",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- こころえ・こころがまえ・こころくばり・こころのこり",
      "- nhận thức; chuẩn bị tinh thần; quan tâm; luyến tiếc",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- はなはだ・すこぶる",
      "- rất (tiêu cực); rất (tích cực); quá mức; cực kì (nhỏ)",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- やけに・いやに・むやみに・やたら",
      "- khác thường; kì lạ; liều lĩnh; bừa bãi",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- ことに・ひときわ・とりわけ",
      "- đặc biệt; khác thường; nổi bật hơn; đặc biệt hơn cả",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- とびきり・かくべつ・だんぜん・いささか",
      "- tuyệt vời nhất; rất khác biệt; chắc chắn hơn; một chút (tiêu cực)",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- そくざ・そっこく・すかさず・とっさに",
      "- ngay lập tức (các sắc thái khác nhau)",
    ],
    more: [
      "📚 Từ loại: Phó từ",
