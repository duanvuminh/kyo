...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- あぜん・ぼうぜん・ばくぜん・きぜん",
      "- sững sờ; ngẩn người; mơ hồ; kiên quyết",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- きがねする・きをつかう",
      "- cảm thấy ngại, khách khí quá mức",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- かたむける・そそぐ",
      "- dốc hết sức; cạnh tranh, ganh đua",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- こみあげる・ふにん・みあわせる",
      "- dâng trào; chuyển công tác; trì hoãn",
    ],
    more: [
      "📚 Từ loại: Động từ",
  ...
  },
  {
    ...
    back: [
      "- ならう",
      "- bắt chước theo; quá trình kinh nghiệm; đầu đuôi sự việc",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- ろうほう・さいぜん",
      "- tin tốt lành; tốt nhất; ngược, đảo lộn",
    ],
    more: [
      "📚 Từ loại: Danh từ",
