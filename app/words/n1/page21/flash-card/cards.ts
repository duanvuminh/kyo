...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- ようだい・きゅうへん",
      "- tình trạng bệnh nhân biến đổi đột ngột",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- てんしん",
      "- chuyển từ công chức thành chính trị gia",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ゆいしょ",
      "- lịch sử, phả hệ công trình, đền thờ",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- しんこう",
      "- kết tình thân giao với nước khác",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
