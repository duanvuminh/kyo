...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- がぜん",
      "- đột nhiên thay đổi (thường theo chiều tích cực)",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- ひとしれず",
      "- âm thầm, không để người khác biết",
    ],
    more: [
      "📚 Từ loại: Phó từ",
  ...
  },
  {
    ...
    back: [
      "- おおかた・おおむね・そうじて",
      "- phần lớn; đại khái; khuynh hướng chung",
    ],
    more: [
      "📚 Từ loại: Phó từ",
