...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- ととのう",
      "- các điều kiện đã được chuẩn bị chu đáo",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- めど",
      "- định hướng hoàn thành công việc",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
