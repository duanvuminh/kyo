...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- しけい・ちょうえき",
      "- phán quyết tử hình/phạt tù cải tạo được đưa ra",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ふんそう",
      "- sự phân tranh, tranh chấp xảy ra",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- じゅうきょあと・はっくつ",
      "- khai quật dấu vết lưu trú của người xưa",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
