...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- じょうきんのしょくいん",
      "- nhân viên thường trực; toàn thời gian",
    ],
    more: [
      "📚 Từ loại: Cụm danh từ",
  ...
  },
  {
    ...
    back: [
      "- ひせいきのしょくいん",
      "- nhân viên không chính thức; hợp đồng tạm thời",
    ],
    more: [
      "📚 Từ loại: Cụm danh từ",
  ...
  },
  {
    ...
    back: [
      "- てんにんする",
      "- chuyển sang bộ phận; cơ quan khác",
    ],
    more: [
      "📚 Từ loại: Động từ",
  ...
  },
  {
    ...
    back: [
      "- きんぞくよんじゅうねんでたいしょくする",
      "- về hưu sau 40 năm làm việc liên tục",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ふけいき・ふきょう",
      "- tình hình kinh doanh khó khăn; suy thoái kinh tế",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- しゃいんをこうぼする",
      "- công khai tuyển dụng nhân viên",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- さいようしけんをとっぱする",
      "- vượt qua bài kiểm tra tuyển dụng",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
