...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- さきごろ・さきだって",
      "- gần đây; mấy hôm trước; chuẩn bị trước; trước đây; từ lâu; thời kì qua",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- おって・もっか・ながらく",
      "- sắp tới; sắp sửa; chẳng mấy chốc; hiện tại; từ trước; một chút; lâu dài",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- さぞ",
      "- chắc chắn là rất (suy đoán đồng cảm)",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- てっきり",
      "- đinh ninh là như thế nhưng thực tế không phải vậy",
    ],
    more: [
      "📚 Từ loại: Phó từ suy đoán",
  ...
  },
  {
    ...
    back: [
      "- いかにも・いっけん・どうやら",
      "- nhìn nào cũng thấy như thế; nhìn sơ qua; có cảm giác thật sự; có vẻ như",
    ],
    more: [
  ...
  },
  {
    ...
    back: [
      "- かろうじて・あやうく",
      "- vừa đủ, suýt sao; suýt nữa là xảy ra điều xấu",
    ],
    more: [
      "📚 Từ loại: Phó từ",
