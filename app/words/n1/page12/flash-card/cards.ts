...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- ちょうこう",
      "- chú ý đến triệu chứng của bệnh",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- じかく",
      "- triệu chứng do bản thân người bệnh cảm nhận",
    ],
    more: [
      "📚 Từ loại: Danh từ",
  ...
  },
  {
    ...
    back: [
      "- おうしん",
      "- nhận được việc bác sĩ đến khám tại nhà",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- おうきゅうしょち",
      "- xử lý khẩn cấp người bệnh/nạn nhân",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- あんせい",
      "- giữ trạng thái nghỉ ngơi yên tĩnh",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ひとすじ",
      "- tập trung toàn bộ sức lực cho âm nhạc",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- せいだい",
      "- tràng vỗ tay rộn ràng vang lên",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
