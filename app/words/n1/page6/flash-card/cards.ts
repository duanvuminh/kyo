...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- すいぶんのほきゅうをこころがける",
      "- cố gắng cung cấp đủ nước cho cơ thể",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ふせっせいなせいかつはきんもつだ",
      "- sinh hoạt không điều độ là điều nên tránh",
    ],
    more: [
      "📚 Từ loại: Cụm cố định",
  ...
  },
  {
    ...
    back: [
      "- がんじょうそうなからだつき",
      "- vóc người trông rắn chắc, cường tráng",
    ],
    more: [
      "📚 Từ loại: Cụm danh từ",
  ...
  },
  {
    ...
    back: [
      "- けいかいなきょく",
      "- ca khúc vui nhộn; tươi vui; nhẹ nhàng",
    ],
    more: [
      "📚 Từ loại: Cụm danh từ",
