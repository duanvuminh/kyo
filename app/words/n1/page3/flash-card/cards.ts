...
export const cards: FlashCardItem[] = [
  ...
  },
  {
    ...
    back: [
      "- そざいをぎんみする",
      "- giám định; lựa chọn kỹ nguyên liệu",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- あっさりしたあじ",
      "- vị thanh tao; nhẹ nhàng; không ngấy",
    ],
    more: [
      "📚 Từ loại: Cụm danh từ",
  ...
  },
  {
    ...
    back: [
      "- こどもをしつける",
      "- dạy con cách xử sự; rèn nếp con",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- いくじにあたまをなやます",
      "- đau đầu; vất vả khi nuôi dạy con",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- いくじをほうきする",
      "- lơ là; bỏ mặc việc nuôi dạy con",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
