...
export const cards: FlashCardItem[] = [
  {
    ...
    back: [
      "- やしきのがいかん",
      "- diện mạo bên ngoài của dinh thự, căn nhà",
    ],
    more: [
      "📚 Từ loại: Cụm danh từ",
  ...
  },
  {
    ...
    back: [
      "- へやのしょうめいにこる",
      "- chú trọng vào ánh sáng của căn phòng",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- ろうかがきしむ",
      "- hành lang phát ra tiếng cót két",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- きょじゅうしゃでくみあいをけっせいする",
      "- tạo liên kết bởi những người sống cùng chung cư",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- そうじきでへやのごみをすいとる",
      "- hút bụi trong phòng bằng máy hút bụi",
    ],
    more: [
      "📚 Từ loại: Cụm động từ",
  ...
  },
  {
    ...
    back: [
      "- せいかつけん",
      "- khu vực sống; phạm vi sinh hoạt",
    ],
    more: [
      "📚 Từ loại: Danh từ",
