...
export const cards: FlashCardItem[] = [
  {
    ...
    questions: [
      {
        id: "5-1",
        content: "今後の交渉結果___、プロジェクトが中止になるかもしれない。",
        answers: ["いかんによっては", "をものともせず", "をよそに", "ならいざしらず"],
        correctAnswer: 0,
        memo: [
  ...
  },
  {
    ...
    questions: [
      {
        id: "5-2",
        content: "理由の___、無断欠席は認められません。",
        answers: ["いかんにかかわらず", "いかんだ", "をよそに", "をものともせず"],
        correctAnswer: 0,
        memo: [
  ...
  },
  {
    ...
    questions: [
      {
        id: "5-3",
        content: "彼女は病気___、毎日練習を続けた。",
        answers: ["をものともせず", "をよそに", "いかんにかかわらず", "ならいざしらず"],
        correctAnswer: 0,
        memo: [
  ...
  },
  {
    ...
    questions: [
      {
        id: "5-5",
        content: "周囲の反対___、彼は会社を辞めて起業した。",
        answers: ["をよそに", "をものともせず", "いかんにかかわらず", "ならいざしらず"],
        correctAnswer: 0,
        memo: [
  ...
  },
  {
    ...
    questions: [
      {
        id: "5-6",
        content: "子供___、大人がこんな失礼なことをするとは信じられない。",
        answers: ["ならいざしらず", "をよそに", "をものともせず", "いかんだ"],
        correctAnswer: 0,
        memo: [
