"use client";
import { JumpToPage } from "@/lib/components/paging/jump-to-page";
import { PaginationNav } from "@/lib/components/paging/pagination-nav";
...
export function KBasePaging({
  ...
  return (
    <div className="not-prose flex flex-col items-center gap-2 mt-1">
      <Pagination>
        <PaginationNav
